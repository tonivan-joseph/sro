<section class="item-content ">
	...
	<div class="form-content">
		<form class="item-form" accept-charset="iso-8859-1,utf-8" method="POST">
			...
			<label for="">Criar Páginas com Menu:</label>
			<input class="check" type="checkbox" name="ad_menu" value="sim" /><br/>

			<label for="">Autor da Página:</label>
			<input class="text" type="text" name="autor" />
			<label >Corpo do POST:</label></br>
			<textarea id="id_textarea" name="corpo_pages"></textarea>
